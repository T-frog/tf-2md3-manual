...
\newcommand{\rev}{rev.3 - October 15th, 2013}
...
To see a copy of this license, visit http://creativecommons.org/licenses/by-sa/3.0/ or send a letter to Creative Commons, 171 Second Street, Suite 300, San Francisco, California, 94105, USA.
All derivative works are to be attributed to Atsushi Watanabe of t-frog.com.
}
...
rev.2   & August 17th, 2013  & 量産版モータドライバ TF-2MD3-R6 の情報を追加 \\
        ...
        &                    & ファームウェア書き込み方法修正 \\
        &                    & モータピン配置の誤り修正 \\
rev.3   & October 17th, 2013 & 免責事項を追加 \\
        &                    & DCモータピン配置の誤り修正 \\
\hline
\end{tabular}
\end{center}
