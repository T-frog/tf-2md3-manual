...
\newcommand{\rev}{rev.2 - July 20th, 2013}
...
rev.2 & July 20th, 2013 & 量産版モータドライバ TF-2MD3-R6 の情報を追加 \\
      &                 & 型番の決定に伴う文章タイトル変更 \\
      &                 & プレ製品化版のスペック修正 \\
      &                 & ファームウェア書き込み方法修正 \\
\hline
...
\figurename~\ref{fig:example_robot} に例を示すような、独立二輪躁舵型(差動駆動型)等の移動ロボットの制御が可能です。
